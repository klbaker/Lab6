...
class JournalEntry extends HTMLElement {
  ...
  set entry(entry) {
    ...
    console.log(sRoot);
    console.log('test');
    sRoot.querySelector('.entry-title').innerHTML = entry.title;
    sRoot.querySelector('.entry-date').innerHTML = entry.date;
    sRoot.querySelector('.entry-content').innerHTML = entry.content;
